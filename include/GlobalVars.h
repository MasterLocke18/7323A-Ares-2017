...
//Creates variablees that will be used to allow the driver to select the proper autonomous
...
//Creates variables that will be used to stop the robot in an emergency
extern int clawtime;
...
//Creates variables that will be used to assign power to motors on the robot
...
//Creates variables that will be used to prevent the lift from over-extending and over-collapsing
extern int Bat1;
extern int Bat2;
extern int Bat3;
extern int status;
